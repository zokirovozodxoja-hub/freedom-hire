  ...
  return (
    <div
      style={{
        ...
        background: src ? undefined : "linear-gradient(135deg, #5B2ECC, #7C4AE8)",
    ...
    >
      {src ? (
        ...
        <span style={{ color: "#fff", fontWeight: 700, fontSize: size * 0.38 }}>{letter}</span>
      )}
    </div>
  );
}
...
export default function MessengerPage() {
  ...
  useEffect(() => {
    (async () => {
      ...
      // auto-open first if none selected
  ...
  return (
    <div style={{ display: "flex", height: "calc(100vh - 64px)", background: "var(--ink)", overflow: "hidden" }}>
      ...
      <div style={{
        ...
        borderRight: "1px solid rgba(196,173,255,0.1)",
        background: "rgba(10,6,24,0.6)",
      }}>

        {/* Sidebar header */}
        <div style={{ padding: "18px 16px 12px", borderBottom: "1px solid rgba(196,173,255,0.08)" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
            <span style={{ fontFamily: "'DM Sans',sans-serif", fontWeight: 700, fontSize: 18, color: "var(--chalk)" }}>
              Чаты
            </span>
            {totalUnread > 0 && (
              <span style={{
                background: "var(--brand-core)", color: "#fff",
          ...
          <label style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 10, cursor: "pointer" }}>
            <div
              ...
              style={{
                ...
                background: filterUnread ? "var(--brand-core)" : "rgba(255,255,255,0.1)",
                border: `1px solid ${filterUnread ? "var(--brand-core)" : "rgba(255,255,255,0.2)"}`,
                display: "flex", alignItems: "center", justifyContent: "center",
                transition: "all .15s",
              }}
            >
            ...
            <span style={{ fontSize: 13, color: "rgba(255,255,255,0.5)", userSelect: "none" }}>
                ...
                <div
                  ...
                  style={{
                    ...
                    background: isActive
                      ...
                      ? "rgba(92,46,204,0.06)"
                      : "transparent",
                    borderLeft: isActive ? "3px solid var(--brand-core)" : "3px solid transparent",
                    transition: "all .15s",
                  }}
                  onMouseEnter={(e) => {
                  ...
                  onMouseLeave={(e) => {
                    if (!isActive) (e.currentTarget as HTMLElement).style.background =
                      conv.unreadCount > 0 ? "rgba(92,46,204,0.06)" : "transparent";
                  }}
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", gap: 4 }}>
                      <span style={{
                        ...
                        color: conv.unreadCount > 0 ? "#fff" : "rgba(255,255,255,0.85)",
                    ...
                    <div style={{
                      ...
                      color: conv.unreadCount > 0 ? "rgba(255,255,255,0.7)" : "rgba(255,255,255,0.35)",
                      whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis",
      ...
      {activeConv ? (
        <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
          ...
          <div style={{
            ...
            background: "rgba(10,6,24,0.7)", backdropFilter: "blur(12px)",
            flexShrink: 0,
          }}>
            <Avatar src={activeConv.partnerAvatar} name={activeConv.partnerName} size={40} radius={10} />

            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontWeight: 600, fontSize: 15, color: "var(--chalk)" }}>
                {activeConv.partnerName ?? "Пользователь"}
              </div>
              {activeConv.jobTitle && (
                <div style={{ fontSize: 12, color: "var(--lavender)", marginTop: 1 }}>
                  {activeConv.jobTitle}
                </div>
              )}
            </div>
            ...
            {/* Link to job */}
            {activeConv.jobId && (
              <Link href={`/jobs/${activeConv.jobId}`} style={{
            ...
            {activeConv.partnerRole === "candidate" && (
              <Link href={`/candidates/${activeConv.partnerId}`} style={{
            ...
            {loadingMsgs ? (
              <div style={{ display: "flex", justifyContent: "center", padding: 40 }}>
                <div style={{
                  ...
                  border: "2px solid rgba(196,173,255,0.2)", borderTopColor: "var(--lavender)",
              ...
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100%", gap: 12 }}>
                <div style={{
                  ...
                  background: "rgba(92,46,204,0.12)", border: "1px solid rgba(92,46,204,0.2)",
                  display: "flex", alignItems: "center", justifyContent: "center",
                }}>
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--lavender)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
                  </svg>
                </div>
                <p style={{ fontSize: 14, color: "rgba(255,255,255,0.4)" }}>
                  Начните диалог с {activeConv.partnerName ?? "пользователем"}
                </p>
              </div>
            ) : (
                        ...
                        <div key={msg.id} style={{
                          ...
                          <div style={{
                            ...
                            borderRadius: msg.isMine
                              ? (prevSame ? "18px 4px 18px 18px" : "18px 18px 4px 18px")
                              : (prevSame ? "4px 18px 18px 18px" : "18px 18px 18px 4px"),
                            background: msg.isMine
                              ? "linear-gradient(135deg, #5B2ECC, #7C4AE8)"
                              : "rgba(255,255,255,0.07)",
                            border: msg.isMine ? "none" : "1px solid rgba(255,255,255,0.08)",
                            boxShadow: msg.isMine ? "0 4px 20px rgba(92,46,204,0.35)" : "none",
                          }}>
                            <p style={{
                            ...
                            <div style={{
                              ...
                              <span style={{
                                fontSize: 11,
                                color: msg.isMine ? "rgba(255,255,255,0.45)" : "rgba(255,255,255,0.3)",
                              }}>
                                {formatTime(msg.createdAt)}
                              </span>
                              {msg.isMine && (
                                <svg width="13" height="13" viewBox="0 0 24 24" fill="none"
                                  stroke={msg.isRead ? "rgba(255,255,255,0.7)" : "rgba(255,255,255,0.3)"}
          ...
          <div style={{
            ...
            borderTop: "1px solid rgba(196,173,255,0.08)",
            background: "rgba(10,6,24,0.9)", backdropFilter: "blur(12px)",
          }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, maxWidth: 720, margin: "0 auto" }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: text.trim() ? "linear-gradient(135deg, #5B2ECC, #7C4AE8)" : "rgba(255,255,255,0.08)",
                  display: "flex", alignItems: "center", justifyContent: "center",
                  flexShrink: 0, transition: "all .2s",
                  boxShadow: text.trim() ? "0 4px 16px rgba(92,46,204,0.4)" : "none",
                }}
              >
                {sending ? (
                  <div style={{
                  ...
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                    stroke={text.trim() ? "#fff" : "rgba(255,255,255,0.3)"}
        ...
        <div style={{
          ...
          <div style={{
            ...
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="var(--lavender)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
            </svg>
          </div>
          <div style={{ textAlign: "center" }}>
            <p style={{ fontSize: 16, fontWeight: 600, color: "var(--chalk)", marginBottom: 6 }}>
              Выберите диалог
            </p>
            <p style={{ fontSize: 13, color: "rgba(255,255,255,0.35)" }}>
              Выберите чат слева или откликнитесь на вакансию
            </p>
          </div>
          <Link href="/jobs" style={{
            ...
            boxShadow: "0 8px 24px rgba(92,46,204,0.4)",
          }}>
            Смотреть вакансии
          </Link>
        </div>
