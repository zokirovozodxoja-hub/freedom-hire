...
const ru: Translations = {
 ...
 features: [
 { title: "Удалённая работа", desc: "Найдите работу в офисе, удалённо или в гибридном формате" },
 ...
 employerDesc: "Создайте компанию и публикуйте вакансии. Получайте отклики от тысяч соискателей по всему миру.",
 ...
 about: {
 title: "О нас",
 description: "FreedomHIRE — международная платформа для поиска работы и найма. Здесь соискатели находят вакансии, а компании быстро закрывают позиции.",
 badge: "О ПРОЕКТЕ",
 tagline: "Международная платформа для поиска работы и найма. Соискатели находят подходящие вакансии, а компании быстро закрывают открытые позиции — без лишних шагов и скрытых платежей.",
 ...
 text: "Мы создали FreedomHIRE чтобы работодатели могли находить людей быстро, а соискатели — понимать статус своего отклика и получать честную обратную связь. Рынок труда постоянно меняется, и нужны современные инструменты найма.",
 },
 values: {
 title: "ЦЕННОСТИ",
 items: [
 { icon: "speed", title: "Скорость", desc: "Разместить вакансию или отправить отклик — дело 2 минут. Мы убрали всё лишнее." },
 { icon: "global", title: "Глобальность", desc: "Работайте с кандидатами и компаниями из разных стран и городов." },
 ...
 { icon: "", title: "Международные кандидаты", desc: "Найдите специалистов из разных городов и стран." },
 ...
 meta: {
 title: "Freedom HIRE — Международная платформа найма",
 description: "Найдите работу мечты или лучших сотрудников. Тысячи вакансий от компаний по всему миру.",
 ogTitle: "Freedom HIRE",
 ogDescription: "Международная платформа найма",
 },
};
