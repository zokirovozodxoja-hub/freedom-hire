      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 py-10">
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-4 text-sm" style={{ color: "rgba(255,255,255,0.6)" }}>
                ...
                {companyData.employees_count && (
                  <span className="flex items-center gap-1">
                    <span>👥</span>
                    {companyData.employees_count} сотрудников
                  </span>
                )}
                {companyData.website && (
                  <a href={companyData.website} target="_blank" rel="noopener noreferrer"
                    className="flex items-center gap-1 hover:underline" style={{ color: "#C4ADFF" }}>
                    <span>🌐</span>
                    Сайт компании
                  </a>
                )}
        ...
        <div>
          <h2 className="text-2xl font-bold mb-4 flex items-center gap-2">
            ...
            Открытые вакансии
            {jobsList.length > 0 && (
              <span className="text-base font-normal" style={{ color: "rgba(255,255,255,0.5)" }}>
                ({jobsList.length})
              </span>
            )}
          </h2>
